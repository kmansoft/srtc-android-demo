...
TOKEN=$(aws ivs-realtime create-participant-token --duration 1440 --stage-arn arn:aws:ivs:us-west-2:422437114350:stage/R0uaOh27PasU --output json | jq -r ".participantToken.token")
